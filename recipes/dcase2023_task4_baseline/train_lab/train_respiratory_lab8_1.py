...
from desed_task.nnet.EzhouNet_v8_1 import GraphRespiratory
from local.respira_trainer_v8_1 import RespiraSED_lab
...
# V7-6-1,   开始使用 区域裁剪， 然后，使用线性插值， 之后使用归一化的语谱图作为特征；
