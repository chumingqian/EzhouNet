...
class RespiraSED_lab(pl.LightningModule):
    ...
    def __init__(
        ...
        #self.vad_loss_fn = nn.BCELoss()  # For node VAD prediction    主导损失， 先完成正常异常二分类
        # Compute pos_weight
        num_neg = 88613
        num_pos = 29682
        alpha_negative = 1.0
        ...
        self.node_vad_loss_weight = 5.0   # 时间属性
    ...
    def training_step(self, batch_data, batch_indx):
        ...
        node_emb_vad_pred = node_emb_vad_pred.squeeze(-1)
    ...
    def validation_step(self, batch_data, batch_indx):
       ...
       # self.valid_frame_loss =  self.frame_loss_weight * self.valid_frame_loss
        ...
        self.valid_total_loss =   (self.valid_node_loss   + self.valid_edge_loss
                                   + self.consistency_loss + self.vad_node_emb_vad_loss
