...
from desed_task.nnet.EzhouNet_v7_1_4 import GraphRespiratory
from local.respira_trainer_v7_3_4 import RespiraSED_lab
...
#  V7-3-2:
#  use  5 classes 5 frames;
#  将vad 的特征用于  边的标签生成， 不再加入到节点特征中；
#  edge_attr, edge_embed  都改进为采用依据节点的特征生成的；



# V7-3-3:   使用 edge_pred_refine 进行边的预测， 并且 factor layer 使用原始的方式；
# v7-3-4,  edge attr  是依据 边的两个节点特征生成。；
