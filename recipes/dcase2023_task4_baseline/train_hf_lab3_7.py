...
from desed_task.nnet.EzhouNet_hf_v3_4 import GraphRespiratory
from local.respira_trainer_hf_v3_7 import RespiraSED_lab
...
# hf_lab3_7:  保留 steth 听诊的数据， 去除 HF 多通道设备的音频数据，
