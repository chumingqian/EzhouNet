...
class RespiraSED_lab(pl.LightningModule):
    ...
    def training_step(self, batch_data, batch_indx):
        ...
        if len(predicted_abnormal_indices) == 0:
            ...
            # note,  这里生成的节点标签， 是针对被样本被预测为异常的样本， 换言之， 如果很多异常样本没有被正确分类， 则导致很多异常节点没有被算入到其中。
            ...
            # After obtaining node_predictions and node_labels
            ...
            # Determine number of normal nodes to sample
