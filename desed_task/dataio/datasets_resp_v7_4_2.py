...
class RespiraGnnSet(Dataset):
    ...
    def spec_extract_features(self, audio, binary_label):
        ...
        mel_resize_normalization = (revise_mel_resize - revise_mel_resize.min()) / (
                    revise_mel_resize.max() - revise_mel_resize.min())
        ...
        cqt_resize_normalization = (revise_cqt_resize - revise_cqt_resize.min()) / (
                    revise_cqt_resize.max() - revise_cqt_resize.min())
