...
class RespiraSED_lab(pl.LightningModule):
    ...
    def __init__(
        ...
        node_alpha = [0.0579, 0.2483, 0.0691, 0.5932, 0.0315]  # for 5 classes
        self.node_alpha = torch.tensor(node_alpha, dtype=torch.float32)
        self.cls_node_loss_fn = FocalLoss(alpha=self.node_alpha, gamma=2.0, reduction='mean')
