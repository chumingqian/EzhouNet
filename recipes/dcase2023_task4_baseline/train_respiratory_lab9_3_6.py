...
from desed_task.nnet.EzhouNet_v9_3_6 import GraphRespiratory
from local.respira_trainer_v9_2_2 import RespiraSED_lab
...
# 实验,   使用公用特征， 同时使用集成 head，
# 将区间置信度， 分类， 定位放在一起； weight param = [-1.0, 1.0]



#  v9-3-6,  集成头； 修正边的属性生成方式，  将 edge 的特征属性生成的方式， 改为顺序的从高维到低维的转换，
#  原始的方式是从低维度到 高维度的转换， node embedding 使用原始的方式； weight param = [-1.0, 1.0]
