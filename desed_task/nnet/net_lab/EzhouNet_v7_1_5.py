...
class GraphRespiratory(nn.Module):
    def __init__(self, in_channels, hidden_channels, out_channels, num_classes,
        ...
        # Learnable edge attribute
        self.edge_attr_val = nn.Parameter(torch.randn(1, 1))
            ...
            for num_nodes in num_nodes_per_sample:
                ...
                if num_nodes_sample > 1:
                    ...
                    for src, dst in zip(edge_index[0], edge_index[1]):
                        ...
                        # Use the learnable edge attribute
                        edge_attrs.append([self.edge_attr_val.item()])  # Alternatively, use self.edge_attr_val directly
                    ...
                    edge_features = self.edge_encoder(edge_attr)  # [E, 2]
