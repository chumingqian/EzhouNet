...
from desed_task.nnet.EzhouNet_v8_17 import GraphRespiratory
...
#  v8-17 使用用 hard confidence ,硬置信度，  但是节点分类不参与计算；
# 由于节点不参与分类， 修改帧数为每两帧生成一个节点，  则此时的节点个数翻一倍；
...
def prepare_run(argv=None):
    ...
    parser.add_argument(
        "--conf_file",
        default="./confs/rep_lab8_17.yaml",
