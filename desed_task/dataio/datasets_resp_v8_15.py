...
#  v8_15,  对每个样本，减少先验区间的个数，
#  并且使用三种尺度轮流循环的方式，到最终的结束时间；
...
class RespiraGnnSet(Dataset):
    def __init__(
        ...
        for i in range(num_anchor_intervals):
            center = (i + 0.5) / num_anchor_intervals  # evenly spaced centers in [0,1]
        ...
        self.anchor_intervals = torch.tensor(anchor_intervals)
