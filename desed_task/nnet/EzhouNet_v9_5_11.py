...
from desed_task.nnet.DCNN_v9_5_11  import  DynamicFeatureExtractor
...
class GraphRespiratory(nn.Module):
    ...
    def forward(self, batch_data, level):
        ...
        if level == "node":
            ...
            pred_output = self.node_interval_pred(batch_graph, audio_durations, anchor_intervals, self.fs, self.frame_hop, chunk_size, stride)
