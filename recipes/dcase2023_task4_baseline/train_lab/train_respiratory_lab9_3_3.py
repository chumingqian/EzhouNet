...
from desed_task.dataio.datasets_resp_v9_3_1 import RespiraGnnSet
from desed_task.nnet.EzhouNet_v9_3_3 import GraphRespiratory
...
#  v9-3-1,  从3种尺度调整为5种尺度，    weight_para 的区间范围和 dist_bins 个数对应上；
# 重新设置区间尺度 ， 以及区间个数；  [0.5, 0.75, 1s,  1.25s,  1.6s]  五种尺度，
# 0.75s, 1s  这两种尺度最多， 其次是 0.5s,  最后两种个数最少；
# 设置  weight param 为 [-100, 100],   设置 clmap  截断区间， 确保不超过范围；


#  v9-3-3,  从3种尺度调整为5种尺度，
# 设置  weight param 为 [-0.5, 0.5],   设置 clmap  截断区间， 确保不超过范围；
