...
# v3, 将语谱图分块的 操作从 collate_fn 移动到 forward 中完成，
# 用于 加快批处理速度；

from desed_task.dataio.datasets_resp_v3 import RespiraGnnSet
from desed_task.nnet.EzhouNet_v3 import GNNRespiraModel
from local.respira_trainer_v3_1 import RespiraSED_lab
