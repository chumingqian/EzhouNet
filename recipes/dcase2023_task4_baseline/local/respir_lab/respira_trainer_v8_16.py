...
class RespiraSED_lab(pl.LightningModule):
    ...
    def __init__(
        ...
        self.interval_location_loss_weight = 3.0
        self.interval_distill_loss_weight = 20.00
    ...
    def configure_optimizers(self):
        ...
        node_learing_params = (
            list(self.sed_net.spec_fea_generator.parameters()) +
            list(self.sed_net.anchor_feat_generator.parameters()) +
            # list(self.sed_net.node_vad_proj.parameters()) +
            list(self.sed_net.edge_encoder.parameters()) +
            list(self.sed_net.anchor_interval_pred.parameters())
