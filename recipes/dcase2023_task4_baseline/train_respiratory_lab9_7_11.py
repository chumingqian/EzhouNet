...
from desed_task.nnet.EzhouNet_v9_7_11 import GraphRespiratory
from local.respira_trainer_v9_7_11 import RespiraSED_lab
...
# v9-7-11;  区间GT的 置信度保留为 0.2 ；
# interval学习率为  1e-4;
# #  修改的边的属性特征为 压缩方式；
# 后续 通过调整 interval  param= [-20, 20]  来进行研究调整；
