...
from desed_task.nnet.EzhouNet_v9_5_3 import GraphRespiratory
from local.respira_trainer_v9_5_4 import RespiraSED_lab, DebugCallback, CustomModelCheckpoint
...
# v9-5-3, group  frames = 25 frames;
# 1.将置信度损失与分类损失，分阶段优化；
# 2. 调整置信度的损失函数；
# 注意 time position  与chunk size 的变化；


# v9-5-4, group  frames = 25 frames;
# 采用课程学习的方式， 逐阶段优化每个每种损失函数
