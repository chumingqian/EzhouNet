...
class RespiraSED_lab(pl.LightningModule):
    ...
    def __init__(
        ...
        self.classes_labels = classes_6labels
        ...
        self.epoch_node_label_counts = torch.zeros(6, dtype=torch.long)
        self.valid_epoch_node_label_counts = torch.zeros(6, dtype=torch.long)
    ...
    def training_step(self, batch_data, batch_indx):
        ...
        batch_label_counts = torch.bincount(node_labels, minlength=6)
