...
from desed_task.nnet.EzhouNet_v9_2_8 import GraphRespiratory
from local.respira_trainer_v9_2_3 import RespiraSED_lab
...
#   并且以区间损失为主导损失；  此时，节点损失起到辅助作用； wight para = [-20, 20]


#  v9-2-8, 到 5 帧一个节点，  wight para = [-20, 20],
#  dist_bins_list=[ 200, 160, 200]
