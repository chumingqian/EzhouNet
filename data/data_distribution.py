...
def plot_histogram(proportions_df, data_stage):
    ...
    # Save plot
    output_path = data_stage +  '_event_duration_histogram.png'
...
def main():
    ...
    # path = './Train_set/train_set_refine_crackle.tsv'
    # data_stage = 'SPRsound_Train'

    # path = './Train_set/valid_set_refine_crackle.tsv'
    # data_stage = 'SPRsound_valid'

    path = './Test_set/test_set_four_cls.tsv'
    data_stage = 'SPRsound_test'
