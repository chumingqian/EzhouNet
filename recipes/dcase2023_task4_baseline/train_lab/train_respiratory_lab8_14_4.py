...
from desed_task.nnet.EzhouNet_v8_14_4 import GraphRespiratory
from local.respira_trainer_v8_14_3 import RespiraSED_lab
...
#  v8-14_4;    取出 x 中的 time feat, 直接使用 x = node_embedding;
#  v8-14_5;   直接使用 x = node_embedding,
#  并且调节 数据增强中的比率 从0.5 调整成 0.85, 过多的数据增强，破坏了原始异常信号的特征；
