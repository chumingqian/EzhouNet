...
class RespiraSED_lab(pl.LightningModule):
    ...
    def training_step(self, batch_data, batch_idx):
       ...
       # print(f"total_loss grad_fn: {total_loss.grad_fn is not None}")
        ...
        # optimize the interval confidence : 200-400 epoch
        ...
        # optimize the interval class & localization: 400-500 epoch
            ...
            total_loss = alpha3 * (conf_loss) + interval_cls_loss + loc_loss

        # joint  optimize the total loss  : 500 epoch   ~
        else:
            total_loss =  conf_loss + interval_cls_loss + loc_loss
