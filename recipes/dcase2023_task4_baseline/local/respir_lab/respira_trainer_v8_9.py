...
class RespiraSED_lab(pl.LightningModule):
    ...
    def __init__(
        ...
        self.interval_conf_loss_weight =  20.0
        self.interval_cls_loss_weight =   10.0
    ...
    def training_step(self, batch_data, batch_indx):
        ...
        # 3. Build IoU-based GT ground truth (class & location) assignment for each sample in the batch
        for b_idx in range(batch_size):
    ...
    def validation_step(self, batch_data, batch_indx):
        ...
        # self.log("valid/interval_distill_loss", distill_loss)

        self.log("valid/total_loss", valid_total_loss, prog_bar=True)
        ...
        self.valid_step_outputs['total_loss'].append(valid_total_loss)
    ...
    def configure_optimizers(self):
        ...
        node_learing_params = (
            ...
            list(self.sed_net.interval_pred.parameters())
...
# 用于binary 二进制的类别不均衡的 focal loss
