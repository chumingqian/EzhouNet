...
from desed_task.dataio.datasets_resp_v7_3 import RespiraGnnSet
from desed_task.nnet.EzhouNet_v7_4_2_3 import GraphRespiratory
from local.respira_trainer_v7_4_2 import RespiraSED_lab
...
#  V7-4-1:   use  subgraph consisent
#  use  5 classes, no wheeze+crackle, combine the fine& coarse crackle as one ; 5 frames;


#  V7-4-2:  bring back the vad info to gen edge label;
#  use  subgraph consisent, 5 classses,
