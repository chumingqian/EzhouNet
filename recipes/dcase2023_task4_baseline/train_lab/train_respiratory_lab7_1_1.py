...
from desed_task.dataio.datasets_resp_v6_5_5 import RespiraGnnSet
from desed_task.nnet.EzhouNet_v7_1_1 import GraphRespiratory
from local.respira_trainer_v7_1_1 import RespiraSED_lab
...
# def calculate_node_class_weights(dataset):
#     # Count each class
...
#
# # In your model or training loop setup
# class_weights = calculate_class_weights(self.train_data)
