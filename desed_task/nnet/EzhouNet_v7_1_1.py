...
class GraphRespiratory(nn.Module):
    ...
    def forward(self, batch_data, level):
        ...
        if level == "node":
            ...
            # note, it's  wrong here,  this  leak the  time label information to the model,
            # because this  use the  label info  to gen the  node features,
            ...
            outputs = {
                ...
                'edge_predictions': edge_predictions_refined, # note, it's wrong should be edge_predictions ;
