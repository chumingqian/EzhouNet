...
class RespiraSED_lab(pl.LightningModule):
    ...
    def __init__(
        ...
        self.interval_unify_head_params = (list(self.sed_net.node_interval_pred.interval_refine.interval_refine_head.parameters()) +
                                           list(self.sed_net.node_interval_pred.interval_refine.interval_conf_heads.parameters()) +
                                           list(self.sed_net.node_interval_pred.interval_refine.interval_class_heads.parameters())
                                           )
