...
from desed_task.dataio.datasets_resp_v2 import RespiraGnnSet
from desed_task.nnet.EzhouNet import GNNRespiraModel
...
from local.respira_trainer import RespiraSED_lab
...
class ControlProfiler(Callback):
    def on_train_start(self, trainer, pl_module):
        trainer.profiler.start("train")  # Explicitly start profiling

    def on_train_end(self, trainer, pl_module):
        trainer.profiler.stop("train")  # Stop profiling after training

    def on_validation_start(self, trainer, pl_module):
        trainer.profiler.start("validation")  # Restart for validation

    def on_validation_end(self, trainer, pl_module):
        trainer.profiler.stop("validation")  # Stop after validation
...
def single_run(
    ...
    if fast_dev_run:
        ...
        limit_train_batches = 0.001  #2 , bt =48;
