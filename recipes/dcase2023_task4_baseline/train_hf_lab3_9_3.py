...
from desed_task.nnet.EzhouNet_hf_v3_9_3 import GraphRespiratory
from local.respira_trainer_hf_v3_9_3 import RespiraSED_lab
...
def single_run(
    ...
    trainer = pl.Trainer(
        ...
        # accelerator="gpu",
        # devices=1,
        strategy = "auto", #None   #=config["training"].get("backend"),
...
def prepare_run(argv=None):
    ...
    parser.add_argument(
        "--conf_file",
        default="./confs/hf_rep_lab3_7.yaml",
