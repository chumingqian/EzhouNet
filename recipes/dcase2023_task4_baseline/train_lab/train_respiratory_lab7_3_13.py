...
from desed_task.nnet.EzhouNet_v7_1_13_2 import GraphRespiratory
from local.respira_trainer_v7_3_13_2 import RespiraSED_lab
...
#  V7-3-12:    增加 node vad 使用 nn.sigmoid ， 提高他的重要性； 这对于区分正常异常 至关重要；


#  V7-3-13 :   增加node vad 的特征维度， 减小 node fea 的特征维度；
