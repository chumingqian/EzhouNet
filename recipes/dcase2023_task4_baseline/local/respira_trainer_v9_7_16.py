...
class RespiraSED_lab(pl.LightningModule):
    ...
    def __init__(
        ...
        # note, automatic opti  closed,  use with  manual  opti
    ...
    def configure_optimizers(self):
        # Learning rates
        lr_node = 1e-3  # Learning rate for shared and node parameters
        lr_interval = 1e-3  # Learning rate for interval parameters
        ...
        #     optimizer_interval,
        #     T_max=600,  # Larger T_max for slower decay
        #     eta_min=1e-4  # Minimum learning rate for interval parameters
        # )
