...
# v9-3-9:  调整为双向 Bigru,  将 node pred 提前，
# 并使用节点分类的结果 生成边的特征；
...
class Node_Interval_cls_Module(nn.Module):
    ...
    def forward(self, data, audio_dur, anchor_intervals, node_preds, fs, frame_hop  ): # pass the batch data
...
class GraphRespiratory(nn.Module):
    def __init__(self, in_channels, hidden_channels, out_channels, num_classes,
        ...
        self.edge_encoder = nn.Linear( num_classes *2, edge_feature_dim) # *2, due to  combine two edge_proj
