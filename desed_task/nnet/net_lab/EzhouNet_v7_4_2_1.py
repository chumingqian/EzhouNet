...
class Node_Edge_cls_Module(nn.Module):
    ...
    def forward(self, data):
        ...
        for i in range(num_audios):
            ...
            ## Step 6:  Collect Subgraph Node Embeddings and Labels
            for sub_nodes in subgraphs:
                ...
                subgraph_node_emb = node_embeddings[sub_nodes_tensor]
        ...
        if subgraph_node_embeddings:
            ...
            # subgraph_predictions_list = list of [1, subgraph_num_classes]
            # Here, we have [num_subgraphs, subgraph_num_classes], so no need to loop

            # Convert to list if needed for consistency loss
