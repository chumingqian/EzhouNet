...
class RespiraSED_lab(pl.LightningModule):
    ...
    def __init__(
        ...
        self.iou_threshold = 0.5    #, change  for the  lab
        ...
        # self.interval_location_loss_weight = 0.05
    ...
    def configure_optimizers(self):
        ...
        optimizer = torch.optim.Adam([
            {'params': node_learing_params, 'lr': self.node_lr_initial, 'name': 'node_interval_cls'}, ])
        ...
        scheduler = torch.optim.lr_scheduler.LambdaLR(
            optimizer,
            lr_lambda=[
                lambda epoch: self.compute_lr_factor(epoch, 'node_interval_cls'), ]
        )
